...
('40000000-0000-0000-0000-000000000000', 'Diploma in Community Oral Health', 'Comprehensive diploma program in community oral health with emphasis on preventive, promotive, and curative services with strong clinical exposure and applied research. Preventive, promotive, curative and community-based oral health services with strong clinical exposure and applied research.', '3 years', ARRAY['KCSE Mean Grade C (Plain) or equivalent', 'C and above in Chemistry, Physics or Mathematics (any one)', 'C in English or Kiswahili'])
ON CONFLICT (title) DO NOTHING;
